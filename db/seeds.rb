...
Agent.create(:name => '三重野', :mail_address => 'mieno@gmail.com', :department => '経理部災害対策課')
Agent.create(:name => '中村', :mail_address => 'nakamura@gmail.com', :department => '人事部災害対策課')
Agent.create(:name => '林', :mail_address => 'hayashi@gmail.com', :department => '総務部災害対策課')

Agent.create(:name => '片本', :mail_address => 'katamoto@gmail.com', :department => '経理部災害対策課')
Agent.create(:name => '安田', :mail_address => 'yasuda@gmail.com', :department => '営業部災害対策課')
Agent.create(:name => '青木', :mail_address => 'aoki@gmail.com', :department => '総務部災害対策課')
Agent.create(:name => '五十嵐', :mail_address => 'igarashi@gmail.com', :department => '人事部災害対策課')
Agent.create(:name => '佐々木', :mail_address => 'sasaki@gmail.com', :department => '総務部災害対策課')

Agent.create(:name => '塩谷', :mail_address => 'shiotani@gmail.com', :department => '経理部災害対策課')
Agent.create(:name => '田辺', :mail_address => 'tanabe@gmail.com', :department => '営業部災害対策課')
Agent.create(:name => '吉田', :mail_address => 'yoshida@gmail.com', :department => '人事部災害対策課')
Agent.create(:name => '山本', :mail_address => 'yamamoto@gmail.com', :department => '総務部災害対策課')
Agent.create(:name => '加藤', :mail_address => 'kato@gmail.com', :department => '経理部災害対策課')

Agent.create(:name => '高橋', :mail_address => 'takahashi@gmail.com', :department => '営業部災害対策課')
Agent.create(:name => '内村', :mail_address => 'uchimura@gmail.com', :department => '営業部災害対策課')
Agent.create(:name => '田中', :mail_address => 'tanaka@gmail.com', :department => '総務部災害対策課')
Agent.create(:name => '山田', :mail_address => 'yamada@gmail.com', :department => '営業部災害対策課')
Agent.create(:name => '内田', :mail_address => 'uchida@gmail.com', :department => '人事部災害対策課')

Agent.create(:name => '井上', :mail_address => 'inoue@gmail.com', :department => '経理部災害対策課')
Agent.create(:name => '小林', :mail_address => 'kobayashi@gmail.com', :department => '総務部災害対策課')
Agent.create(:name => '中村', :mail_address => 'nakamura@gmail.com', :department => '営業部災害対策課')
Agent.create(:name => '伊藤', :mail_address => 'ito@gmail.com', :department => '営業部災害対策課')
Agent.create(:name => '渡邊', :mail_address => 'watanabe@gmail.com', :department => '総務部災害対策課')
...
Agent.create(:name => '阿部', :mail_address => 'abe@gmail.com', :department => '開発部災害対策課')
Agent.create(:name => '森', :mail_address => 'mori@gmail.com', :department => '事業部災害対策課')
Agent.create(:name => '橋本', :mail_address => 'hashimoto@gmail.com', :department => '開発部災害対策課')

Agent.create(:name => '山下', :mail_address => 'yamashita@gmail.com', :department => '事業部災害対策課')
Agent.create(:name => '石川', :mail_address => 'ishikawa@gmail.com', :department => '開発部災害対策課')
Agent.create(:name => '中島', :mail_address => 'nakazima@gmail.com', :department => '総務部災害対策課')
Agent.create(:name => '前田', :mail_address => 'maeda@gmail.com', :department => '事業部災害対策課')
Agent.create(:name => '小川', :mail_address => 'ogawa@gmail.com', :department => '事業部災害対策課')

Agent.create(:name => '岡田', :mail_address => 'okada@gmail.com', :department => '開発部災害対策課')
Agent.create(:name => '後藤', :mail_address => 'gotou@gmail.com', :department => '事業部災害対策課')
Agent.create(:name => '長谷川', :mail_address => 'hasegawa@gmail.com', :department => '事業部災害対策課')
Agent.create(:name => '村上', :mail_address => 'murakami@gmail.com', :department => '開発部災害対策課')
Agent.create(:name => '遠藤', :mail_address => 'endo@gmail.com', :department => '事業部災害対策課')
